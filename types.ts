...
export type LightbulbCommands = | Message<"TURN_LIGHT_ON", LightbulbData>
    ...
    | Message<"TURN_LIGHT_OFF", LightbulbData>;
export type LightBulbEvents = | Message<"LIGHTBULB_INSTALLED", LightbulbData> | Message<"LIGHT_TURNED_ON", LightbulbData> | Message<"LIGHT_TURNED_OFF", LightbulbData>
